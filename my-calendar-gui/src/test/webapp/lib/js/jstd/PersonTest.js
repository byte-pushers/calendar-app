TestCase("PersonTestCases", { 
	testCreatingEmail: function() {
		var email = new NoesisCodeModels.Email("tonte.pouncil@gmail.com", true, "Home");
	...
	testCreatingPerson: function() {
		...
		var person = new NoesisCodeModels.Person("Tonte", "Torrance", "Pouncil");
		assertNotUndefined("person should be defined.", person);
		var email1 = new NoesisCodeModels.Email("tonte.pouncil@gmail.com", true, "Home");
		var email2 = new NoesisCodeModels.Email("pouncilt.developer@gmail.com", true, "Work");
