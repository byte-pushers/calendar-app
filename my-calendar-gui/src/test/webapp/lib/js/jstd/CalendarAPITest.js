TestCase("CalendarAPITestCases", {
	...
	testStaticGetMonthIndex: function(){
		assertEquals(CalendarApp.com.noesiscode.calendar.models.Month, CalendarApp.models.Month);
		assertEquals(8, CalendarApp.models.Month.getMonthIndex("Sep"));
	}
});
