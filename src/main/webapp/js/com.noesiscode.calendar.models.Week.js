...
CalendarApp.models.Week = function (weekdays) {
    ...
    this.isWeekOf = function (date) {
        var dateFoundInWeek = false;
        this.weekdays.every(function (weekday) {
            if (weekday !== undefined && weekday !== null) {
                if (weekday.getDate().getFullYear() === date.getFullYear()) {
                    if (weekday.getDate().getMonth() === date.getMonth()) {
                        if (weekday.getDate().getDate() === date.getDate()) {
                            dateFoundInWeek = true;
                            return false;
                        }
                    }
